...
pub trait TokenService: Send + Sync {
    ...
    async fn generate_email_verification_jwt(
        &self,
        user_id: Uuid,
        email: String,
        username: String,
    ...
    async fn validate_email_verification_jwt(
        &self,
        token: &str,
...
impl TokenService for DefaultTokenService {
    ...
    async fn generate_access_token(
        ...
        JwtUtils::generate_token(user_id, email, username, expiration_hours, "access")
    }
    ...
    async fn generate_refresh_token(
        ...
        JwtUtils::generate_token(user_id, email, username, expiration_hours, "refresh")
    }
    ...
    async fn generate_password_reset_token(
        ...
        JwtUtils::generate_token(user_id, email, username, expiration_hours, "password_reset")
    }
